...
public class PostController {
  ...
  public PostDto createPost(@RequestBody PostDto post) {
    return ImmutablePostDto.copyOf(post).withId(23L).withTitle("Mock title - just created");
  }
  ...
  public List<PostDto> fetchPostsByAuthor(@RequestParam("author") Long[] authorIds) {
    return singletonList(ImmutablePostDto.copyOf(getMockPost()).withTitle("Mock title - from /findByAuthor"));
  }
  ...
  public List<PostDto> fetchPostsByCategories(@RequestParam("category") Long[] categories) {
    return singletonList(ImmutablePostDto.copyOf(getMockPost()).withTitle("Mock title - from /findByCategory"));
  }
